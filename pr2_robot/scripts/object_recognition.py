...
# world1: biscuits, soap, soap2
# world2: biscuits, soap, book, soap2, glue
# world3: sticky_notes, book, snacks, biscuits, eraser, soap2, soap, glue
...
# Exercise-2 TODOs:
    ...
    #max_distance = 0.01
    # 0.02 is pretty good, just bottom parts slightly cut off
    max_distance = 0.02
...
if __name__ == '__main__':
    ...
    probe_pub = rospy.Publisher("/prj_probe", PointCloud2, queue_size=1)
